"""
PDF Report Generator for InsightStream Forensic
...
def generate_forensic_pdf(analysis, case_info, output_path):
    ...
    # ===== HEADER =====
    story.append(Paragraph("InsightStream Forensic", title_style))
    ...
    This report was generated by InsightStream Forensic Discovery Engine<br/>
